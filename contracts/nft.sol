...
contract WalletNFT is ERC165, IERC721 {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address _owner = WalletNFT.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(WalletNFT.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(WalletNFT.ownerOf(tokenId), to, tokenId);
    }
